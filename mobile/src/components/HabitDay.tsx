...
import { generateProgressPercentage } from '../utils/generate-process-percentage';
    ...
    return (
        <TouchableOpacity
            className={clsx("rounded-lg border-2 m-1", {
                ...
                ["bg-violet-600 border-violet-500"]: amountAccomplishedPercentage >= 40 && amountAccomplishedPercentage < 80,
